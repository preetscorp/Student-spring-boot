package com.springboot.tryouts.demo.aspect;
...
public class LoggerAspect {
	...
	@Around("execution(* com.springboot.tryouts.demo.service.impl..*(..)) || execution(* com.springboot.tryouts.demo.controller..*(..))")
	...
	@AfterThrowing(pointcut = "execution(*  com.springboot.tryouts.demo.service.impl..*(..)) ||  execution(* com.springboot.tryouts.demo.controller..*(..))",
					throwing = "ex")
